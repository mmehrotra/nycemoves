...
import com.nyce.moves.ImageRequest;
import com.nyce.moves.ModelApiResponse;
import com.nyce.moves.VideoRequest;
...
public class MediaApiController implements MediaApi {
    ...
    public ResponseEntity<ModelApiResponse> applaudImageByImageId(@ApiParam(value = "The ImageId of the image",required=true) @PathVariable("imageId") Integer imageId) {
    ...
    public ResponseEntity<ModelApiResponse> applaudVideosByVideoId(@ApiParam(value = "The video id of the video which need to be fetched",required=true) @PathVariable("videoId") Integer videoId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<ModelApiResponse>(objectMapper.readValue("{  \"code\" : \"code\",  \"message\" : \"message\",  \"status\" : \"SUCCESS\"}", ModelApiResponse.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<ModelApiResponse> deleteImage(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "imageId", required = true) String imageId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<ModelApiResponse>(objectMapper.readValue("{  \"code\" : \"code\",  \"message\" : \"message\",  \"status\" : \"SUCCESS\"}", ModelApiResponse.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<ModelApiResponse> deleteVideo(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "videoId", required = true) String videoId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<ModelApiResponse>(objectMapper.readValue("{  \"code\" : \"code\",  \"message\" : \"message\",  \"status\" : \"SUCCESS\"}", ModelApiResponse.class), HttpStatus.NOT_IMPLEMENTED);

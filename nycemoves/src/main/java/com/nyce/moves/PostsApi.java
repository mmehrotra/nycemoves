...
public interface PostsApi {
    ...
    @ApiOperation(value = "Delete a post", nickname = "deletePost", notes = "Delete a post", response = ModelApiResponse.class, tags={ "posts", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<ModelApiResponse> deletePost(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "postId", required = true) String postId);

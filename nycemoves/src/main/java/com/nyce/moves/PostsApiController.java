...
import com.nyce.moves.PostRequest;
...
public class PostsApiController implements PostsApi {
    ...
    public ResponseEntity<ModelApiResponse> deletePost(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "postId", required = true) String postId) {

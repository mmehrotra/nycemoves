...
import com.nyce.moves.CommentsRequest;
...
public class CommentsApiController implements CommentsApi {
    ...
    public ResponseEntity<ModelApiResponse> deleteComment(@ApiParam(value = "The playerId for which comment needs to be deleted" ,required=true) @RequestHeader(value="playerId", required=true) String playerId,@ApiParam(value = "" ,required=true) @RequestHeader(value="commentId", required=true) Integer commentId) {

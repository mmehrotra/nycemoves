...
public interface MediaApi {
    ...
    @ApiOperation(value = "Get the posts submitted by the user ordered by timestamp desc", nickname = "applaudImageByImageId", notes = "", response = ModelApiResponse.class, tags={ "images", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ModelApiResponse.class) })
    @RequestMapping(value = "/media/images/{imageId}/appluad",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> applaudImageByImageId(@ApiParam(value = "The ImageId of the image",required=true) @PathVariable("imageId") Integer imageId);


    @ApiOperation(value = "Applaud / Like the by video id", nickname = "applaudVideosByVideoId", notes = "", response = ModelApiResponse.class, tags={ "videos", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ModelApiResponse.class) })
    @RequestMapping(value = "/media/videos/{videoId}/appluad",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> applaudVideosByVideoId(@ApiParam(value = "The video id of the video which need to be fetched",required=true) @PathVariable("videoId") Integer videoId);


    @ApiOperation(value = "Delete a image", nickname = "deleteImage", notes = "Delete a image", response = ModelApiResponse.class, tags={ "images", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ModelApiResponse.class),
    ...
    ResponseEntity<ModelApiResponse> deleteImage(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "imageId", required = true) String imageId);


    @ApiOperation(value = "Delete a video", nickname = "deleteVideo", notes = "Delete a video", response = ModelApiResponse.class, tags={ "videos", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ModelApiResponse.class),
        @ApiResponse(code = 400, message = "Invalid playerId supplied"),
        @ApiResponse(code = 404, message = "PlayerId not found") })
    @RequestMapping(value = "/media/videos/players/{playerId}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<ModelApiResponse> deleteVideo(@ApiParam(value = "The playerId for which post needs to be deleted",required=true) @PathVariable("playerId") String playerId,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "videoId", required = true) String videoId);

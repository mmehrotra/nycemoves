...
public class Player   {
  ...
  **/
  ...
  public Player dob(OffsetDateTime dob) {
    this.dob = dob;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(playerId, email, firstName, lastName, password, displayName, city, country, gender, school, primarySport, dob, creationTime, updateTime, numberOfConnections);
  }
